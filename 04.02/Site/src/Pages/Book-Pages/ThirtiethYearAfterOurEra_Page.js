...
import ThirtiethYearAfterOurEra_Component from '../../Components/Components-Book/ThirtiethYearAfterOurEra_Components/ThirtiethYearAfterOurEra_Component';
...
export default function ThirtiethYearAfterOurEra_Page() {
    return (
      <div className='App'>
        <Header_Component/>
        <ThirtiethYearAfterOurEra_Component/>
        <Footer_Component/>
